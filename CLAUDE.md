...
- **ゲーム機互換(将来予定)**: PS6(2026-08-08時点で未発売・未発表の
  次世代機)のゲームが4K120FPS・Dolby Vision 2 ULTRA
  (2026-08-08時点でこのセッションからは実在する公開仕様として裏付けが
  取れていない——将来正式仕様が公開された時点で改めて確認すること)
  相当で動作すること、Nintendo Switch 2のゲームアプリの動作互換も予定。
